...
atk4 = myfont.render("Inspiration", False, (0, 0, 0))
...
class Hagura(personnage):  #on crée la class de notre premier personnage.
    ...
    def HaguraFist(self, cible): #Attaque 1
        nbreDegat = 45
        if self.PE >= 10:
    ...
    def Inspiration(self, cible): #Attaque 1
        nbreDegat = 5
        if self.PE >= 6:
            print("Hagura inspire son allié B), il lui confère" +str(nbreDegat))
            cible.vie += nbreDegat
            self.PE -= 10
            print("il reste "+str(self.PE) +"PE")
        else:
...
PLAYERMajNwar = MajNwar(245, 250, "Maj Nwar", 55)
    ...
    if event.type == pygame.MOUSEBUTTONDOWN :
                if pygame.mouse.get_pressed() == (1,0,0):
                    ...
                    if 0 < mouse[0] < 148 and 630 < mouse[1] < 710:
                        ...
                        text_anim("Hagura charge son Hagura Fist !")
                        pygame.time.wait(1000)
                        refresh_console()
                        ...
                        pygame.time.wait(1000)
                        pygame.draw.rect(gameDisplay, noir,(301,630,600,200))
                        PLAYERHagura.Inspiration(PLAYERMajNwar)
                        text_anim("Hagura inspire son allié !")
                        pygame.time.wait(1000)
                        refresh_console()
                        text_anim("Cela lui restore 5 PV !")
                        pygame.time.wait(1000)
                        tab_atk()
                        clicked = True
