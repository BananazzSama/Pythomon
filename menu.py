        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN :
                if pygame.mouse.get_pressed() == (1,0,0):
                    ...
                    if 270 < mouse[0] < 470 and 250 <  mouse[1] < 450 :
                        yugi.stop()
                        import charselect                                  #ecran selection personnage


                    elif 270 < mouse[0] < 470 and 450 <  mouse[1] < 650 : #écran crédits
                        intro = False
                        credit()


                    elif 270 < mouse[0] < 470 and 650 <  mouse[1] < 750 :
                        intro = False
                        pygame.quit()
...
def credit():
    ...
    pygame.draw.rect(gameDisplay, blanc,(18,758,110,30))
...
def lose():
     """
    Fonction qui permet d'afficher l'écran de défaite contenant
    un bouton  "PLAY AGAIN" , "CREDITS" et "QUIT"
